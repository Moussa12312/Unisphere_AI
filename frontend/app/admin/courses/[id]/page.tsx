      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="bg-blue-100 text-blue-700 text-xs font-medium px-2.5 py-1 rounded-full font-mono">{course.code}</span>
          </div>
          <p className="text-slate-500 mt-1">{course.department} • Niveau {course.level}</p>
        </div>
