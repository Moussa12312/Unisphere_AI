...
PAYMENT_LIST = "payment:list"          # ✅ AJOUTÉ
FEE_CREATE = "fee:create"              # ✅ AJOUTÉ
FEE_READ = "fee:read"                  # ✅ AJOUTÉ
FEE_UPDATE = "fee:update"              # ✅ AJOUTÉ
FEE_DELETE = "fee:delete"              # ✅ AJOUTÉ
FEE_LIST = "fee:list"                  # ✅ AJOUTÉ
...
ATTENDANCE_LIST = "attendance:list"    # ✅ AJOUTÉ
...
DOCUMENT_LIST = "document:list"        # ✅ AJOUTÉ
...
REPORT_LIST = "report:list"            # ✅ AJOUTÉ
AI_ACCESS = "ai:access"
...
def get_all_permissions():
    ...
    return {
        "students": [STUDENT_CREATE, STUDENT_READ, STUDENT_UPDATE, STUDENT_DELETE, STUDENT_LIST, STUDENT_SCAN],
