...
import PrintQRCodesModal from '@/components/admin/PrintQRCodesModal';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <p className="text-slate-500">Gérez tous les étudiants de l'université</p>
        </div>

        <div className="flex items-center gap-3">
          <button
            onClick={() => setShowQRModal(true)}
            className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-medium transition-all shadow-md"
          >
            <Printer size={16} />
            Print QR Codes
          </button>
